...
;; (describe "Warnings generated by `display-warning'"
;;   :var (local-warning-buffer-name buttercup-warning-buffer-name)
;;   (before-each (setq local-warning-buffer-name "warning-test-buffer"
;;                      buttercup-warning-buffer-name local-warning-buffer-name))
;;   (it "should be collected in `buttercup-warning-buffer-name'"
;;     ;;(get-buffer-create buttercup-warning-buffer-name)
;;     (display-warning 'buttercup "This warning should be collected")
;;     (expect (with-current-buffer local-warning-buffer-name
;;               (buffer-string))
;;             :to-equal "This warning should be collected")
